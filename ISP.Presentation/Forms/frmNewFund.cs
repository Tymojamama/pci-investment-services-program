...
namespace ISP.Presentation.Forms
{
    public partial class frmNewFund : Form, IMessageFilter
    {
        ...
        private void LoadCategoryCbo()
        {
            ...
            {
                cboCategory.Items.Add(new ListItem(_stringMap.Value, _stringMap.Id.ToString()));
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Fund fund = new Fund();
            fund.FundName = txtName.Text;
            fund.Ticker = txtTicker.Text;
            fund.Family = txtFamily.Text;
            fund.CUSIP = txtCusip.Text;
            fund.CategoryId = _categoryId;
            fund.RecordType = _recordType;

            try
            {
                fund.SaveRecordToDatabase(frmMain_Parent.CurrentUser.UserId);
                this.Close();
            }
