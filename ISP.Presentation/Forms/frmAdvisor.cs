    ...
    public partial class frmAdvisor : Form, IMessageFilter
    {
        ...
        private void btnOpenMgr_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                _frmManager.FormClosed += mf_parent.frmManager_FormClosed;
            }
        }
        ...
        {
            lstMgmt.Items.Clear();
            foreach (DataRow dr in ISP.Business.Entities.AdvisorsManagement.GetAssociatedFromAdvisor(CurrentAdvisor.Id).Rows)
            {
